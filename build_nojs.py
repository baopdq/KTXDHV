...
BQL_NAV = [
    ...
    ("quan-ly-dang-ky", "Quản lý đăng ký"),
    ("quan-ly-hop-dong", "Quản lý hợp đồng"),
    ("vat-tu-phong", "Quản lý vật tư phòng"),
    ("quan-ly-thanh-toan", "Quản lý thanh toán"),
    ("Vận hành", None),
    ("ho-so-noi-tru", "Hồ sơ nội trú"),
    ("diem-danh", "Điểm danh sinh viên"),
    ("phe-duyet-don", "Phê duyệt đơn (nhanh)"),
    ("thiet-lap-phong", "Thiết lập phòng KTX"),
    ("tra-cuu-phong", "Tra cứu phòng trống"),
    ("toa-nha", "Tòa nhà"),
    ("Báo cáo — thống kê", None),
    ("thong-ke-lap-day", "Thống kê lấp đầy"),
    ("thong-ke-doanh-thu", "Thống kê doanh thu"),
    ("Hệ thống", None),
    ("quan-ly-thong-bao", "Thông báo"),
    ("quan-ly-tai-khoan", "Người dùng"),
    ("doi-mat-khau", "Cài đặt / đổi mật khẩu"),
    ("tich-hop", "VNPay & tích hợp"),
]
...
def replace_aside(html: str, inner: str):
    return re.sub(
        r'<aside id="sidebar" class="sidebar">[\s\S]*?</aside>',
